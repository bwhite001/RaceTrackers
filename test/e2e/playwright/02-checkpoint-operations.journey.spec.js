...
test.describe('Checkpoint Volunteer – Mark-Off Journey', () => {
  ...
  test('navigates to checkpoint and sees runner grid', async ({ page }) => {
    await goHome(page);
  ...
  test('marks off a single runner via the runner grid', async ({ page }) => {
  ...
  test('marks off multiple runners via Quick Entry', async ({ page }) => {
    await page.goto('/checkpoint/1');
  ...
  test('switches to Callout Sheet tab', async ({ page }) => {
    await page.goto('/checkpoint/1');
  ...
  test('switches to Overview tab and shows runner counts', async ({ page }) => {
    await page.goto('/checkpoint/1');
    await page.waitForSelector('nav[aria-label="Checkpoint tabs"]', { timeout: 15000 });
  ...
  test('can export checkpoint results', async ({ page }) => {
    await page.goto('/checkpoint/1');
    await page.waitForSelector('nav[aria-label="Checkpoint tabs"]', { timeout: 15000 });
