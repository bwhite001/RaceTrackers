...
test.describe('Navigation Protection Journey', () => {
  ...
  test('shows protection modal when leaving active checkpoint operation', async ({ page }) => {
  ...
  test('allows navigation after confirming exit from active operation', async ({ page }) => {
    await page.goto('/checkpoint/1');
    await page.waitForURL(/\/checkpoint\/1/);
  ...
  test('home page module cards are all accessible when no operation is active', async ({ page }) => {
    await page.goto('/');
