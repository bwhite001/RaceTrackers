 ...
 *
 * #32 Rows used py-4, making the table needlessly tall on the small screens
 *     operators actually use at a checkpoint.
...
describe('M-4 / #32: compact rows', () => {
  beforeEach(() => {
    mockMode = APP_MODES.CHECKPOINT;
    mockRunners = [{ number: 1, status: RUNNER_STATUSES.NOT_STARTED, recordedTime: null }];
  });

  it('uses py-2 row padding, not py-4', () => {
    render(<RunnerOverview />);
