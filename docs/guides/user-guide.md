...
![Step 21](assets/creates-a-new-race-from-scratch-and-verifies-the-overview-step-21.png)

![Step 22](assets/creates-a-new-race-from-scratch-and-verifies-the-overview-step-22.png)

![Step 23](assets/creates-a-new-race-from-scratch-and-verifies-the-overview-step-23.png)
...
![Step 5](assets/step-indicator-advances-correctly-through-setup-wizard-step-05.png)

![Step 6](assets/step-indicator-advances-correctly-through-setup-wizard-step-06.png)

![Step 7](assets/step-indicator-advances-correctly-through-setup-wizard-step-07.png)

![Step 8](assets/step-indicator-advances-correctly-through-setup-wizard-step-08.png)

![Step 9](assets/step-indicator-advances-correctly-through-setup-wizard-step-09.png)
...
![Step 5](assets/back-button-on-step-2-returns-to-race-details-with-data-preserved-step-05.png)

![Step 6](assets/back-button-on-step-2-returns-to-race-details-with-data-preserved-step-06.png)

![Step 7](assets/back-button-on-step-2-returns-to-race-details-with-data-preserved-step-07.png)

![Step 8](assets/back-button-on-step-2-returns-to-race-details-with-data-preserved-step-08.png)

![Step 9](assets/back-button-on-step-2-returns-to-race-details-with-data-preserved-step-09.png)

![Step 10](assets/back-button-on-step-2-returns-to-race-details-with-data-preserved-step-10.png)

![Step 11](assets/back-button-on-step-2-returns-to-race-details-with-data-preserved-step-11.png)
...
![Step 7](assets/race-management-page-lists-created-races-step-07.png)
...
![Step 7](assets/clicking-a-race-opens-its-overview-step-07.png)

![Step 8](assets/clicking-a-race-opens-its-overview-step-08.png)

![Step 9](assets/clicking-a-race-opens-its-overview-step-09.png)

![Step 10](assets/clicking-a-race-opens-its-overview-step-10.png)

![Step 11](assets/clicking-a-race-opens-its-overview-step-11.png)

![Step 12](assets/clicking-a-race-opens-its-overview-step-12.png)
...
![Step 6](assets/creates-a-second-race-from-the-management-page-step-06.png)

![Step 7](assets/creates-a-second-race-from-the-management-page-step-07.png)

![Step 8](assets/creates-a-second-race-from-the-management-page-step-08.png)

![Step 9](assets/creates-a-second-race-from-the-management-page-step-09.png)

![Step 10](assets/creates-a-second-race-from-the-management-page-step-10.png)

![Step 11](assets/creates-a-second-race-from-the-management-page-step-11.png)

![Step 12](assets/creates-a-second-race-from-the-management-page-step-12.png)

![Step 13](assets/creates-a-second-race-from-the-management-page-step-13.png)

![Step 14](assets/creates-a-second-race-from-the-management-page-step-14.png)

![Step 15](assets/creates-a-second-race-from-the-management-page-step-15.png)

![Step 16](assets/creates-a-second-race-from-the-management-page-step-16.png)

![Step 17](assets/creates-a-second-race-from-the-management-page-step-17.png)
...
![Step 5](assets/race-overview-shows-correct-runner-and-checkpoint-counts-step-05.png)
...
![Step 8](assets/navigates-to-checkpoint-and-sees-runner-grid-step-08.png)

![Step 9](assets/navigates-to-checkpoint-and-sees-runner-grid-step-09.png)

![Step 10](assets/navigates-to-checkpoint-and-sees-runner-grid-step-10.png)

![Step 11](assets/navigates-to-checkpoint-and-sees-runner-grid-step-11.png)
...
![Step 8](assets/marks-off-a-single-runner-via-the-runner-grid-step-08.png)

![Step 9](assets/marks-off-a-single-runner-via-the-runner-grid-step-09.png)

![Step 10](assets/marks-off-a-single-runner-via-the-runner-grid-step-10.png)

![Step 11](assets/marks-off-a-single-runner-via-the-runner-grid-step-11.png)

![Step 12](assets/marks-off-a-single-runner-via-the-runner-grid-step-12.png)
...
![Step 8](assets/marks-off-multiple-runners-via-quick-entry-step-08.png)

![Step 9](assets/marks-off-multiple-runners-via-quick-entry-step-09.png)

![Step 10](assets/marks-off-multiple-runners-via-quick-entry-step-10.png)

![Step 11](assets/marks-off-multiple-runners-via-quick-entry-step-11.png)

![Step 12](assets/marks-off-multiple-runners-via-quick-entry-step-12.png)
...
![Step 1](assets/switches-to-callout-sheet-tab-step-01.png)

![Step 2](assets/switches-to-callout-sheet-tab-step-02.png)

![Step 3](assets/switches-to-callout-sheet-tab-step-03.png)

![Step 4](assets/switches-to-callout-sheet-tab-step-04.png)

![Step 5](assets/switches-to-callout-sheet-tab-step-05.png)

![Step 6](assets/switches-to-callout-sheet-tab-step-06.png)

![Step 7](assets/switches-to-callout-sheet-tab-step-07.png)

![Step 8](assets/switches-to-callout-sheet-tab-step-08.png)

![Step 9](assets/switches-to-callout-sheet-tab-step-09.png)

![Step 10](assets/switches-to-callout-sheet-tab-step-10.png)

![Step 11](assets/switches-to-callout-sheet-tab-step-11.png)
...
![Step 8](assets/switches-to-overview-tab-and-shows-runner-counts-step-08.png)

![Step 9](assets/switches-to-overview-tab-and-shows-runner-counts-step-09.png)

![Step 10](assets/switches-to-overview-tab-and-shows-runner-counts-step-10.png)

![Step 11](assets/switches-to-overview-tab-and-shows-runner-counts-step-11.png)
...
![Step 7](assets/can-export-checkpoint-results-step-07.png)

![Step 8](assets/can-export-checkpoint-results-step-08.png)

![Step 9](assets/can-export-checkpoint-results-step-09.png)

![Step 10](assets/can-export-checkpoint-results-step-10.png)
...
![Step 3](assets/home-page-landing-shows-the-race-management-module-card-step-03.png)

![Step 4](assets/home-page-landing-shows-the-race-management-module-card-step-04.png)

![Step 5](assets/home-page-landing-shows-the-race-management-module-card-step-05.png)
...
![Step 9](assets/shows-protection-modal-when-leaving-active-checkpoint-operation-step-09.png)

![Step 10](assets/shows-protection-modal-when-leaving-active-checkpoint-operation-step-10.png)
...
![Step 9](assets/allows-navigation-after-confirming-exit-from-active-operation-step-09.png)

![Step 10](assets/allows-navigation-after-confirming-exit-from-active-operation-step-10.png)

![Step 11](assets/allows-navigation-after-confirming-exit-from-active-operation-step-11.png)
...
![Step 7](assets/home-page-module-cards-are-all-accessible-when-no-operation-is-active-step-07.png)

![Step 8](assets/home-page-module-cards-are-all-accessible-when-no-operation-is-active-step-08.png)
...
![Step 7](assets/unknown-routes-redirect-to-home-step-07.png)
...
![Step 5](assets/opens-and-closes-the-settings-modal-step-05.png)

![Step 6](assets/opens-and-closes-the-settings-modal-step-06.png)

![Step 7](assets/opens-and-closes-the-settings-modal-step-07.png)

![Step 8](assets/opens-and-closes-the-settings-modal-step-08.png)

![Step 9](assets/opens-and-closes-the-settings-modal-step-09.png)
...
![Step 5](assets/toggles-dark-mode-on-and-off-step-05.png)

![Step 6](assets/toggles-dark-mode-on-and-off-step-06.png)

![Step 7](assets/toggles-dark-mode-on-and-off-step-07.png)

![Step 8](assets/toggles-dark-mode-on-and-off-step-08.png)

![Step 9](assets/toggles-dark-mode-on-and-off-step-09.png)

![Step 10](assets/toggles-dark-mode-on-and-off-step-10.png)

![Step 11](assets/toggles-dark-mode-on-and-off-step-11.png)
...
![Step 5](assets/settings-persist-after-closing-and-reopening-the-modal-step-05.png)

![Step 6](assets/settings-persist-after-closing-and-reopening-the-modal-step-06.png)

![Step 7](assets/settings-persist-after-closing-and-reopening-the-modal-step-07.png)

![Step 8](assets/settings-persist-after-closing-and-reopening-the-modal-step-08.png)

![Step 9](assets/settings-persist-after-closing-and-reopening-the-modal-step-09.png)

![Step 10](assets/settings-persist-after-closing-and-reopening-the-modal-step-10.png)

![Step 11](assets/settings-persist-after-closing-and-reopening-the-modal-step-11.png)
